...
public class MyJoinedOfferActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_joined_offer);
        ...
        String u1 = "Gracz 1: " + post.getAuthor();
        username1.setText(u1);
        contact1.setText(post.getContact());
        String u2 = "Gracz 2: " + post.getOther();
        username2.setText(u2);
        contact2.setText(post.getOther_contact());
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        gmap.animateCamera(CameraUpdateFactory.newLatLngZoom(ny, 13));
    ...
    public LatLng getLocationFromAddress(String strAddress) {
        ...
        try {
            address = coder.getFromLocationName(strAddress, 1, 52.132438, 20.758809, 52.334484, 21.157143);
            if (address == null) {
                return null;
            }
